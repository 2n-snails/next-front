...
import Zzim from "../../../public/static/svg/zzim.svg";
import Call from "../../../public/static/svg/call.svg";
import Siren from "../../../public/static/svg/siren.svg";

import Love from "../../../public/static/svg/love.svg";
import WatchView from "../../../public/static/svg/WatchView.svg";
...
const ProductDetail: React.FC<IProps> = () => {
  ...
  const detailData = productDetail.filter((data) => query.id === (data.productNo).toString());
          ...
          <>
            ...
            <div className="product_detail_info_main_btn">
              <div className="zzim_btn">
                <Button type="button" color="#2fa0ead9" text="찜하기" />
                <Zzim className="zzim_btn_svg" />
              </div>

              <div className="call_btn">
                <Button type="button" color="#9bd00ed9" text="연락하기" />
                <Call className="call_btn_svg" />
              </div>
              <div className="siren_btn">
                <Button type="button" color="#d00e0eb5" text="신고하기" />
